...
export class CreateAppointmentComponent implements OnInit {
  ...
  saveClick(e : Event){
    ...
    e.preventDefault();
    this.appointmentService.createAppointment({id: null, bloodBank: this.createAppointmentForm.controls.bloodBank.value,startTime: this.createAppointmentForm.controls.startTime.value, duration: this.createAppointmentForm.controls.duration.value, nurse: nurse, user:null, finished:false, version: 0}).subscribe({
      next: (res) => {
